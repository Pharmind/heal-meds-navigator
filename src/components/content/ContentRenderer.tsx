...
type Section = 'search' | 'medications' | 'materials' | 'diets' | 'intoxication' | 'high-alert' | 'elderly' | 'sequential-therapy' | 'pharmacovigilance' | 'cft' | 'protocols' | 'pictogram' | 'discharge-guidelines' | 'drug-interactions' | 'treatment-estimation' | 'therapeutic-alternatives' | 'antihypertensive-optimization' | 'antibiotic-guide' | 'multiprofessional-round' | 'round-reports' | 'calculator' | 'user-management';
...
const ContentRenderer = ({
  ...
  const sectionComponents = {
    ...
    'antibiotic-guide': <ClinicalPharmacy activeTab="antibiotic-guide" />,
